...
/**
 * Shapermint checkout upsell — VERSION 2 (UX/copy experiment).
 * Same layout/design system as the original <ShapermintUpsell />, but the
 * headline messaging is rewritten with a savings-first, post-purchase framing:
 * confirms the order first, leads with the value ("2 camis for the price of 1
 * + 20% OFF"), and corrects the offer to "Add a 2nd Cami" since the shopper has
 * already bought one. Kept as a separate component so both versions can run.
...
export const ShapermintUpsellV2 = () => {
          ...
          <div className="css-6corth">
            ...
            <div style={{ textAlign: "center" }} className="css-1qicnhk">
              <div className="css-l66t5u">
                <span className="css-k6nmjj">
                  <span style={{ display: "block" }}>Order confirmed! One last exclusive deal before it ships.</span>
                </span>
              </div>
              <Spacer size={10} />
              <div className="css-l66t5u">
            ...
            <div className="css-l66t5u">
              <span className="css-1gzdh5r">
                <span style={{ display: "block" }}>2 Camis for the Price of 1 — Plus 20% OFF</span>
              </span>
            </div>
            ...
            <div className="css-l66t5u">
              <span className="css-ktibo8">
                <span style={{ display: "block" }}>$90 value, yours today for just $35.99.</span>
              </span>
            </div>
            ...
            <div className="css-l66t5u">
              <span className="css-42km96">
                <span style={{ display: "block" }}>Only on this screen, before your order ships.</span>
              </span>
            </div>
            ...
            <div className="css-l66t5u">
              <span className="css-1i41lyz">
                <span style={{ display: "block" }}>
                  <b style={{ fontWeight: 700 }}>Add a 2nd Shaper Cami — FREE</b>
                  <br />Two camis have a retail value of $90
                  <br />You get both for the price of one
                  <br />Plus an Extra 20% OFF your bundle
                </span>
              </span>
            </div>
...
export default ShapermintUpsellV2;
