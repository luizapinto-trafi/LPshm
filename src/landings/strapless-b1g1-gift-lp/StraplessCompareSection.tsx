...
/** Iconos de marca propios de esta LP (la original usa emoji ✅/❌). */
const CompareBenefitMark = ({ ok }: { ok: boolean }) =>
  ok ? (
    ...
    <svg width={22} height={22} viewBox="0 0 24 24" aria-hidden>
      <circle cx="12" cy="12" r="10" fill="none" stroke="#9ca3af" strokeWidth="2" />
      <path d="M9 9l6 6M15 9l-6 6" stroke="#9ca3af" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
    ...
    <>
      <StyledShmCol>
        <StyledLogoWrap href="https://shapermint.com" aria-label="Shapermint home">
          <Image src={StraplessB1g1Cdn.logo} alt="" width={164} height={28} unoptimized />
        </StyledLogoWrap>
        <CompareProductPhoto
          src={StraplessB1g1Cdn.compareUsProduct}
      ...
      <StyledCompCol>
        ...
        <CompareProductPhoto
          src={StraplessB1g1Cdn.competitor1}
      ...
      <StyledCompCol>
        <StyledCompLabel>{t("compare.compBrand")}</StyledCompLabel>
        <CompareProductPhoto
          src={StraplessB1g1Cdn.competitor2}
