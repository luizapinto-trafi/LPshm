...
export const JellybraPrimaryButton = styled.a<{ $wide?: boolean }>`
  display: inline-flex;
  align-items: center;
...
export const JellybraSplitCta = styled.a<{ $full?: boolean }>`
  display: grid;
...
export const JellybraSplitCtaPart = styled.span`
  display: flex;
  align-items: center;
  justify-content: center;
  min-width: 0;
...
export const JellybraSplitCtaDivider = styled.span`
