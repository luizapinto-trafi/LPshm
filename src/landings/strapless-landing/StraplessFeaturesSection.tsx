...
/* Frame Figma 2350:2644: 3 columnas 441×486 con imagen + nº + título 15/700 + cuerpo 18; assets vía StraplessCdn. */
      ...
      <StyledWrap>
        ...
        <StyledGrid>
          <StyledCard>
            <StyledImageBlock>
              <FeatureImage
                src={StraplessCdn.featBreathe}
                alt={t("features.card1ImageAlt")}
              />
              <StyledTextCol>
                <StyledNumSvgWrap aria-hidden>
                  <Image src={StraplessCdn.featureNum01Svg} alt="" width={53} height={53} unoptimized />
                </StyledNumSvgWrap>
          ...
          <StyledCard>
            <StyledImageBlock>
              ...
              <StyledTextCol>
                <StyledNumSvgWrap aria-hidden>
                  <Image src={StraplessCdn.featureNum02Svg} alt="" width={53} height={53} unoptimized />
                </StyledNumSvgWrap>
