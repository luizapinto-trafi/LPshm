  ...
  return (
    <StyledSection id="buy" aria-labelledby="strapless-pdp-title">
      <StyledInner>
        <StyledGallery>
          <StyledGalleryCell>
            <Image src={StraplessCdn.gallery1} alt={t("pdp.gallery1Alt")} fill sizes="(max-width: 1023px) 100vw, 50vw" />
          </StyledGalleryCell>
          <StyledGalleryCell>
            <Image src={StraplessCdn.gallery2} alt={t("pdp.gallery2Alt")} fill sizes="(max-width: 1023px) 100vw, 50vw" />
          </StyledGalleryCell>
        </StyledGallery>
        ...
        <StyledBuybox>
          ...
          <div>
            ...
            <StyledColorpicker>
              <StyledThumb>
                <Image src={StraplessCdn.swatchBlack} alt="" fill sizes="64px" />
              </StyledThumb>
              <div>
            ...
            <StyledColorpicker style={{ marginTop: 14 }}>
              <StyledThumb>
                <Image src={StraplessCdn.swatchChai} alt="" fill sizes="64px" />
              </StyledThumb>
              <div>
